    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='flex flex-col justify-center '>
                ...
                <p className='text-lg text-gray-600'>Our journey is marked by significant milestones and celebrated triumphs.</p>
                ...
                <div className='grid grid-cols-2 py-16'>
                    <div className='py-6 flex'>
                        ...
                        <div className='px-3'>
                            ...
                            <p className='text-[#6D737A]'>Planners</p>
                        </div>
             ...
             <img  src={achievement} className="m-auto md:order-last  order-first" alt='achievement' />
