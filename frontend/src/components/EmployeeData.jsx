            ...
            <div className="">
              <div className="flex items-center">
                ...
                <div className="flex items-center p-2 bg-card ml-2 rounded-xl">
                  <ArrowRight path="res-react-dash-premium-star" />
                  <div className="ml-2 font-bold text-premium-yellow">PREMIUM</div>
                </div>
              </div>
              <div className="flex items-center">
                <ArrowRight path="res-react-dash-date-indicator" className="w-3 h-3" />
                <div className="ml-2">October 26</div>
              </div>
            </div>
            <ArrowRight icon="res-react-dash-sidebar-open" className="block sm:hidden" onClick={onSidebarHide} />
          </div>
          <div className="w-full sm:w-56 mt-4 sm:mt-0 relative">
            <ArrowRight path="res-react-dash-search" className="w-5 h-5 search-icon left-3 absolute" />
