...
import { ArrowRight } from "react-feather"; // Importing the specific icon 'ArrowRight'
import graphData from "./EmployeeData";
  ...
  const CustomTooltip = () => (
    <div className="rounded-xl overflow-hidden tooltip-head">
      <div className="flex items-center justify-between p-2">
        ...
        <ArrowRight className="w-2 h-2" /> {/* Using 'ArrowRight' icon */}
      </div>
    ...
    <div className="flex p-4 h-full flex-col">
      <div className="">
        <div className="flex items-center">
          ...
          <ArrowRight className="w-4 h-4" /> {/* Using 'ArrowRight' icon */}
